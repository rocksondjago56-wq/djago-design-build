...
export const About: React.FC = () => {
  return (
    <section id="about" className="py-20 lg:py-28 bg-[#11141a] relative overflow-hidden border-t border-b border-slate-800/80">
      ...
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-amber-500/5 blur-3xl rounded-full pointer-events-none animate-pulse-glow" />
      <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-yellow-600/5 blur-3xl rounded-full pointer-events-none animate-float-slow" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="lg:col-span-6 space-y-6">
            <AnimatedSection direction="right" delay={100}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
                <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 glass-card-hover flex items-start gap-3">
          ...
          <div className="lg:col-span-6">
            <AnimatedSection direction="left" delay={200}>
              <div className="relative rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 shadow-2xl group">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-6 rounded-xl bg-slate-950/90 border border-amber-500/30 backdrop-blur-md transition-all group-hover:border-amber-500/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <AnimatedSection direction="up" delay={100}>
            <div className="h-full rounded-2xl bg-slate-900/90 border border-slate-800 p-8 glass-card-hover group">
