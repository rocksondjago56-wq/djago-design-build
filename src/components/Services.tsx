...
import { Paintbrush, Building2, Compass, CheckCircle2, ArrowRight, Sparkles, Download, Layers } from 'lucide-react';
  ...
  return (
    <section id="services" className="py-20 lg:py-28 bg-[#0d0f12] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="rounded-3xl bg-slate-900/90 border border-slate-800 p-6 lg:p-10 shadow-2xl backdrop-blur-xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-6 flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="px-7 py-3.5 bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-slate-950 font-bold font-['Space_Grotesk'] text-xs tracking-wider uppercase rounded-xl transition-all shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2"
                >
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden border border-slate-800 group h-[380px] lg:h-[450px]">
                <img
